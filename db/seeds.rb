...
string_methods = %w[byteindex byteslice capitalize casecmp center chars chr concat count delete delete_prefix delete_suffix downcase dump each_char each_line gsub index insert inspect length lines ljust lstrip match next partition prepend replace rindex rjust rpartition rstrip scan slice split squeeze strip sub swapcase tr tr_s undump upcase upto]
